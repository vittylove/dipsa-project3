...
//                String confir=confirmPassword.getText().toString();
    ...
    public void changePassword() {
        ...
        if(oldPassword.getText().toString().equals(newPassword.getText().toString())){
            Toast.makeText(this, "NewPassword and OldPassword are the same.Please enter different Profile", Toast.LENGTH_LONG).show();
        }
...
//                                                                    finish();
                                        ...
                                        Toast.makeText(ChangePassword.this, "Profile changed successfully", Toast.LENGTH_LONG).show();
                                        startActivity(new Intent(ChangePassword.this, Login.class)
                ...
                Toast.makeText(ChangePassword.this, "Profile mismatch ", Toast.LENGTH_LONG).show();
            }

        }
        else {
            if (!ValidationUtil.passwordValidation(oldPass)) {
                oldPassword.setError("Please enter a the old Profile");
            }
            if (!ValidationUtil.passwordValidation(newPass)) {
                newPassword.setError("Profile must include upperCase, lowerCase, symbols and numbers.");
            }
            if (!ValidationUtil.passwordValidation(confirm)) {
                confirmPassword.setError("Profile must include upperCase, lowerCase, symbols and numbers.");
            }
        }
    }
}
